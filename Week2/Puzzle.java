...
public class Puzzle {
    ...
    public Puzzle(BufferedImage image, int numRows, int numCols, ArrayList<PieceSwap> swapOrder){
        this.image = image;
     ...
     */
    public void swapPieces(PieceSwap swap) {
        int r1 = swap.r1;
        int r2 = swap.r2;
        int c1 = swap.c1;
        int c2 = swap.c2;
    ...
    /**
     * Shuffles the pieces array in a specified way
     */
    private void shufflePieces(ArrayList<PieceSwap> swapOrder){
        // TODO: YOUR CODE HERE
    	// loops through each PieceSwap object in the ArrayList and calls swapPieces on them
    	for (PieceSwap swap : swapOrder) {
    		swapPieces(swap);
    	}

        // call the swapPieces method from above on each PieceSwap object in the swapOrder ArrayList.
    }
