...
public class Webcam extends DrawingGUI {
	protected boolean mac = false;					// automatically set to true for mac, false otherwise
	private static final double scale = 1;		// to downsize the image (for speed), set this to a fraction <= 1
	...
	/**
	 * Processes the grabbed image. Override this method in subclasses. 
	 */
	public void processImage() {
		// Default: nothing
		// We don't do any processing when just running the webcam
	}
